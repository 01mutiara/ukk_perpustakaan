...
<input name="password" type="text" maxlength="4" class="form-control mb-2" placeholder="Password" required>
...
echo"<script>alert('data gagal tersimpan'); window.location.assign('?halaman=data_anggota');</script>";
}
}
?>