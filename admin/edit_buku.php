...
<input value="<?= $data_buku['tahun_terbit'] ?>" name="tahun_terbit" type="number" class="form-control mb-2" placeholder="Judul Buku" required> 
...
echo"<script>alert('data gagal tersimpan'); window.location.assign('?Phalaman=data_buku'); </script>";
}
}
?>